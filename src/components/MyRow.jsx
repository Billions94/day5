                    ...
                    <>
                        <div className="container-fluid overflow-hidden py-5 pl-5">
                            ...
                            <div className="pl-3">
                                ...
                                aria-expanded="false"
                                >
                                <span className="d-inline-block background">Genres</span>
                                </a>
                                <div
                            ...
                            <div className="col-8 d-flex flex-row-reverse pb-2">
                                <button className="btn button-gl genrebtn text-light">
                                <i className="material-icons ">
                                    <img src="./assets/4sqr.png" style={{ width: 20 }} />
                                </i>
                                </button>
                                <button className="btn button-gl genrebtn text-light">
                                <i className="material-icons">
                                    <img src="./assets/star.png" style={{ width: 20 }} />
                                </i>
                                </button>
                            </div>
                            </div>
                            ...
                            <div id="comedy" className="d-flex"></div>
                        </div>
                        {/*--footer*/}
                        <div className="container">
                            ...
                            <div className="pt-3">
                                ...
                                <p>© 1997-2019 Netflix, Inc. All rights reserved.</p>
                                </div>
                            </div>
                            </footer>
                        </div>
